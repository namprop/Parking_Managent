    ...
    <section id="add-vehicle-type" class="mt-6">
        ...
        <form action="/admin/vehicletype" method="POST">
            ...
            <div class="form-group mb-4">
                <input type="text" name="maloaixe" placeholder="Mã Loại Xe" class="p-2 border border-gray-300 rounded w-full" required>
            </div>
            <div class="form-group mb-4">
                <input type="text" name="tenloaixe" placeholder="Tên Loại Xe" class="p-2 border border-gray-300 rounded w-full" required>
            </div>
